...
x = np.genfromtxt("SDS00003.txt", usecols=0)
y = np.genfromtxt("SDS00003.txt", usecols=1)

fig, ax = plt.subplots()
fitpar, fitcov = curve_fit(theoreticalfit, xdata=x, ydata=y, p0=[-0.014, 0.675, 0, 7.7])
...
plt.title("Obremenitev z maso 502g")
plt.xlabel("t [s]")
plt.ylabel("U [V]")
