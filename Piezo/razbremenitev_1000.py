...
fig, ax = plt.subplots()
fitpar, fitcov = curve_fit(theoreticalfit, xdata=x, ydata=y, p0=[0.024, -1.43, 0.004, 7.6])
...
plt.title("Razbremenitev z maso 1005g")
plt.xlabel("t [s]")
plt.ylabel("U [V]")
plt.text(0.48, 0.275, fittext, ha="left", va="center", size=10, transform=ax.transAxes, bbox=dict(facecolor="#a9f5ee", alpha=0.5))
plt.legend(loc=0)
plt.show()
