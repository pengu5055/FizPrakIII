...
amp = np.genfromtxt("nal03_frekv_455.txt", usecols=0)
amp_sttdev = np.genfromtxt("nal03_frekv_455.txt", usecols=1)
amp_lock = np.genfromtxt("nal03_frekv_455.txt", usecols=2)
...
plt.title("Zvocni profil v resonatorju pri 455Hz")
plt.xlabel(r'$r$ [mm]')
